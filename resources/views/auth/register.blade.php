        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a style="margin-right:100px; text-decoration:none; color:white" class="drop" href="{{ route('shop') }}"><i style="margin-right:5px" class="fa-solid fa-shop"></i>Shop</a>  
                ...
                <div style="width: 400px; background-color:white" class="container d-flex justify-content-center shadow-lg mt-5 mb-5 p-4">
                    <form method="POST" action="{{ route('register') }}" class="col">
                        @csrf
                        <h2 style="text-align: center" class="mt-1 mb-5">Register Now</h2>
                        <div class="mb-3">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" class="col" placeholder="Name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-dark  drop">
                                    {{ __('Register') }}
                                </button>
