...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-0 mt-3">
      ...
      <div style="background-color:white !important;" class="py-3">
        <h5 style="margin-left:130px; color:#ffd000">Home  <span style="color:black"> / Contact Us</span></h5>
      </div>
...
<div class="container d-flex justify-content-between mt-3">
    ...
    <p>it is a long established fact that a reader wil be distracted by the readable contact of a page .<br>
        when looking at its layout the point of using lorem ipsum is that it has a more -or-less. <br> normal distributed of letter,  as apossed to using content.
          <br> <br>
             Cecillia Chapman  <br>
             711-2880 Nulia .St  <br> Mankato Mississippi 96522 <br>  
             <a style="text-decoration: none;" href="">(XXX) 555-2368 <br> jim@rock.com</a>
    </p>



    <div class="card mb-5 border-0" style="width: 35rem; background:transparent">
        <div class="card-body">
          <form action="">
         <div class="mb-3">
      ...
      <div class="mb-3">
        <label class=" mb-2" for="">Subject</label>
        <input type="text" class="form-control" placeholder="">
      </div>
    ...
    <button style="padding: 10px 20px 10px 20px;" class="btn btn-dark mt-2 border-0  p">Send Message</button>
