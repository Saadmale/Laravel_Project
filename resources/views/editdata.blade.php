...
@endif
      ...
      <div class="container mt-5 d-flex justify-content-between">
        <div>
        <a style="padding-right:110px; background-color:#ffd000; color:black" class="btn btn-dark border-0 p" href=""><i style="margin-right:10px;" class="fa-solid fa-user"></i>Update</a>
    <br>
        ...
        <br>
        <a style="padding-right:124px; " class="btn btn-dark border-0 mt-2 p" href="{{ route('showdata' )}}"><i style="margin-right:10px;" class="fa-solid fa-user"></i>Users</a>
        <br>
        ...
        <div class="card mb-5" style="width: 60rem;">
          <div class="card-body">
           ...
           <div class="mb-3">
               ...
               <input type="text" name="name" class="form-control @error('name') is-invalid  @enderror" placeholder="Enter Your Name" value="{{ $data->name }}">
               @error('name')
           ...
           <div class="mb-3">
            ...
            <input type="text" name="email" class="form-control  @error('email') is-invalid  @enderror" placeholder="Enter Your Email"  value="{{ $data->email }}">
            @error('email')
            <span class="text-danger">
             {{ $message }}
            </span>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control  @error('phone') is-invalid  @enderror" placeholder="Enter Your Phone" value="{{ $data->phone }}">
            @error('phone')
            <span class="text-danger">
             {{ $message }}
            </span>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="password" class="form-control  @error('password') is-invalid  @enderror" placeholder="Enter Your Password"  value="{{ $data->password }}">
          @error('email')
          <span class="text-danger">
           {{ $message }}
          </span>
