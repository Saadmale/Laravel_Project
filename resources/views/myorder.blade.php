...
<body>
    <div class="container d-flex justify-content-between mt-4">
            ...
            <a style="text-decoration: none; color:black; margin-left:530px;" class="h4  account" href="">My Account</a>
            <form action="">
        <div class="input-group mb-3 col">
          
            <input style="margin-left:10px;" type="search" name="search" class="form-control" placeholder="Search For Products" value="{{ $search }}">
            <span class="input-group-text" id="basic-addon2"><i style="color: #ffd000" class="fa-solid fa-magnifying-glass"></i></span>
          <button style="margin-left:10px;" class="btn btn-outline-warning">Search</button>
          </div>  
        </form>         
    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-0 mt-3">
      ...
      <div style="background-color:white !important;" class="d-flex justify-content-between py-3">
        <h5 style="margin-left:130px; color:#ffd000">My Account  <span style="color:black"> /My Cart</span></h5>
       <img style="margin-left: 1020px;" src="/images/user.png" width="40px;" alt="">  <h5 style="margin-right:50px;" class="mt-1">{{ Auth::User()->name }}</h5>
...
@endif
      ...
      <div class="container mt-5 mb-5 d-flex justify-content-between">
        <div>
        <a style="padding-right:90px; " class="btn btn-dark border-0 p" href="{{ route('home') }}"><i style="margin-right:10px;" class="fa-solid fa-user"></i>My Profile</a>
    <br>
        <a style="padding-right:103px; background-color:#ffd000; color:black" class="btn btn-dark border-0 mt-2 p" href="{{ route('myorder') }}"><i style="margin-right:10px;" class="fa-solid fa-cart-shopping"></i>My Cart</a>
        <br>
        ...
        <div class="card mb-5 shadow-lg" style="width: 60rem;">
          <div class="card-body">
            
            <div class="d-flex justify-content-between">
          
              <h4 class="card-title">My Cart</h4>
              <a style="margin-left:530px;" class="btn btn-success" href="{{ route('check') }}">Proceed to Checkout</a>
              <a style="float: right" class="btn btn-primary" href="{{ url('create') }}">Add Product</a>
            </div>
            ...
            <table class="table table-striped mt-4">
              ...
              <tr>
                <td>
                  <img style="border-radius: 90px;" class="shadow-sm" src="/public/image/{{$data->image}}" width="80px;" alt="">
                </td>
                ...
                <td>
                  <a class="btn btn-success" href="{{ route('edit', $data->id) }}"><i style="margin-right:10px" class="fa-solid fa-pen-to-square"></i>Edit</a>
                  <a onclick="return confirm('Are You Sure')" class="btn btn-danger" href="{{ route('delete', $data->id) }}"><i style="margin-right:10px" class="fa-solid fa-trash"></i>Delete</a>
                </td>
              </tr>
