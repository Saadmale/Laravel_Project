...
<head>
    ...
    <style>
      .box:hover{
  box-shadow: 5px 5px 90px #fdc500 !important;
  transition: 0.5s;
}
...
.pro:hover{
  box-shadow: 5px 5px 140px grey !important;
  transition: 0.5s;
}
    </style>
</head>
<body>
    ...
    <nav  class="navbar navbar-expand-lg navbar-light bg-dark  mt-3">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           ...
           <a style="margin-right:100px; margin-left:30px; text-decoration:none; color:white" class="drop" href="{{ route('shop') }}"><i style="margin-right:5px" class="fa-solid fa-shop"></i>Shop</a> 
          </div>
        </div>
      </nav>
      ...
      <div  class="container mt-5 mb-5 d-flex justify-content-between">
        ...
        <div style="cursor: pointer; text-align:center" class="card mt-5 border-0  box" style="width: 18rem;">
            <div  class="card-body shadow-lg">
                <div class="container d-flex justify-content-between">
                    <h2><i style="width: 10%; color:#ffd000; margin-right:20px" class="fa-solid fa-check"></i></h2>
                    <h4 style="margin-right: 20px;" class="card-title">Quality Product</h4>
                </div>             
            </div>
        </div>
        ...
        <div class="card mt-5 border-0" style="width: 18rem;">
            <div style="cursor: pointer" class="card-body shadow-lg  box">
                <div class="container d-flex justify-content-between">
        ...
        <div class="card mt-5 border-0" style="width: 18rem;">
            <div style="cursor: pointer" class="card-body shadow-lg  box">
                <div class="container d-flex justify-content-between">
                    <h2><i style="width: 10%; color:#ffd000" class="fa-solid fa-phone"></i></h2>
    ...
    <div  class="card mt-3 border-0  cat" style="width: 18rem;">
        <div class="card-body shadow-lg">
            <div class="container d-flex justify-content-between">
    ...
    <div class="card mt-3 border-0 cat" style="width: 18rem;">
      ...
      <div class="container d-flex justify-content-between mt-5 mb-5">
        ...
        <div class="card border-0 shadow-lg  pro" style="width: 14rem;">
            ...
            <div class="card bg-dark" style="width: 18rem;">
              ...
              <div class="card bg-dark" style="width: 18rem;">
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a style="text-decoration: none; color:white" href="{{ url('/home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 drop">Home</a>
                    @else
